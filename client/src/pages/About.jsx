export default function About() {
  ...
  <p>
    Our team consists of three members, each contributing their unique
    skills to this project. Zeresenay focused on backend development and
    database management, ensuring robust and scalable data handling. Hizkeal
    worked on frontend design and development, creating an intuitive and
    visually appealing user interface. Mikiyas integrated an AI chatbot to
    enhance user interaction and provide helpful recommendations.
  </p>
